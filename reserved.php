    ...
    <main>
        <article id="box">
            <div class="flexr">
                ...
                <div>
                    <p class="txt_center max_width font15pt"><?php echo $resultat[1] ?></p>
                    <p class="txt_center max_width font15pt">Début: <?php echo $resultat[3] ?></p>
                    <p class="txt_center max_width font15pt">Fin: <?php echo $resultat[4] ?></p>
